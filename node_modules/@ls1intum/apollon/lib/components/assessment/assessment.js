...
var enhance = react_redux_1.connect(null, {
    ...
    assessNext: function (current) { return function (dispatch, getState) {
...
var AssessmentComponent = /** @class */ (function (_super) {
    ...
    AssessmentComponent.prototype.render = function () {
        ...
        return (react_1.default.createElement("div", { ref: this.container },
            elements.map(function (element, i) { return (react_1.default.createElement(assessment_section_1.AssessmentSection, { key: element.id, element: element })); }),
