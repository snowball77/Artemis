...
var getInitialState = function (props) {
    ...
    if (props.mode === editor_types_1.ApollonMode.Assessment) {
    ...
    else if (props.view === "Exporting" /* Exporting */ || props.view === "Highlight" /* Highlight */) {
        decorators.push(interactable_1.interactable, hoverable_1.hoverable);
    }
    else if (props.view === "Modelling" /* Modelling */) {
        ...
        if (props.features.resizable && features.resizable) {
            ...
            decorators.push(resizable_1.resizable(options));
        }
    ...
    return {
        component: redux_1.compose.apply(void 0, tslib_1.__spread(decorators.reverse()))(component),
    };
};
