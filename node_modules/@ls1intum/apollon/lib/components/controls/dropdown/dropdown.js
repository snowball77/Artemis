...
var Dropdown = /** @class */ (function (_super) {
    ...
    function Dropdown() {
        ...
        _this.activator = react_1.createRef();
    ...
    Dropdown.prototype.render = function () {
        ...
        return (react_1.default.createElement(dropdown_styles_1.StyledDropdown, null,
            react_1.default.createElement(dropdown_button_1.DropdownButton, { ref: this.activator, color: color, onClick: this.show, outline: outline, size: size }, selected ? selected.props.children : this.props.placeholder),
