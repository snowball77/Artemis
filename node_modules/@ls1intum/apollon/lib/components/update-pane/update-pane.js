...
var enhance = redux_1.compose(with_canvas_1.withCanvas, with_root_1.withRoot, react_redux_1.connect(function (state) { return ({
...
var UnwrappedUpdatePane = /** @class */ (function (_super) {
    ...
    UnwrappedUpdatePane.prototype.render = function () {
        ...
        return react_dom_1.createPortal(react_1.default.createElement(popover_1.Popover, { ref: this.popover, position: position, placement: placement, alignment: alignment, maxHeight: 500 },
