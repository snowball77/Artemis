...
var ActivityMergeNodeUpdate = /** @class */ (function (_super) {
    ...
    ActivityMergeNodeUpdate.prototype.render = function () {
        var _this = this;
        var _a = this.props, element = _a.element, decisions = _a.decisions, targets = _a.targets;
...
var enhance = redux_1.compose(localized_1.localized, react_redux_1.connect(function (state, props) {
