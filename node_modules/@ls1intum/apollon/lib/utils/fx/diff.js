...
exports.diff = function (lhs, rhs) {
    ...
    return Object.keys(rhs).reduce(function (acc, key) {
        ...
        if (typeof lhs[key] === 'object') {
            var difference = exports.diff(lhs[key], rhs[key]);
            if (Object.keys(difference).length) {
                return tslib_1.__assign(tslib_1.__assign({}, acc), (_c = {}, _c[key] = exports.diff(lhs[key], rhs[key]), _c));
            }
            else {
                return acc;
            }
