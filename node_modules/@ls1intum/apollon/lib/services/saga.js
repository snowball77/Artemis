...
function saga() {
    return tslib_1.__generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, sagas_1.composeSaga([layouter_1.Layouter, uml_element_saga_1.UMLElementSaga, uml_container_saga_1.UMLContainerSaga, uml_relationship_saga_1.UMLRelationshipSaga, uml_diagram_saga_1.UMLDiagramSaga])];
            case 1:
                _a.sent();
                return [2 /*return*/];
        }
