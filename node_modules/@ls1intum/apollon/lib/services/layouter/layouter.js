...
function Layouter() {
    return tslib_1.__generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, sagas_1.run([layout])];
            case 1:
                _a.sent();
                return [2 /*return*/];
        }
...
function layout() {
    ...
    return tslib_1.__generator(this, function (_e) {
        switch (_e.label) {
            case 0: return [4 /*yield*/, effects_1.take("@@layouter/LAYOUT" /* LAYOUT */)];
            case 1:
                action = _e.sent();
            ...
            case 3:
                ...
                return [4 /*yield*/, effects_1.put(uml_container_repository_1.UMLContainerRepository.append(ids))];
            case 4:
                _e.sent();
                _e.label = 5;
            case 5:
            ...
            case 6:
                ...
                id = _c.value;
                return [4 /*yield*/, effects_1.delay(0)];
            case 7:
                _e.sent();
                if (!uml_element_1.UMLElement.isUMLElement(elements[id])) return [3 /*break*/, 9];
                return [4 /*yield*/, effects_1.call(render, id)];
            case 8:
                _e.sent();
                _e.label = 9;
            case 9:
                if (!uml_relationship_1.UMLRelationship.isUMLRelationship(elements[id])) return [3 /*break*/, 11];
                return [4 /*yield*/, effects_1.call(uml_relationship_saga_1.recalc, id)];
            case 10:
                _e.sent();
                _e.label = 11;
            case 11:
    ...
    return tslib_1.__generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 2:
                ...
                children = tslib_1.__spread(diagram.ownedElements.map(function (x) { return uml_element_repository_1.UMLElementRepository.get(elements[x]); }), diagram.ownedRelationships.map(function (x) { return uml_relationship_repository_1.UMLRelationshipRepository.get(elements[x]); })).filter(not_empty_1.notEmpty);
    ...
    return tslib_1.__generator(this, function (_h) {
        switch (_h.label) {
            ...
            case 11:
                ...
                return [4 /*yield*/, effects_1.put({
                        type: "@@element/movable/MOVE" /* MOVE */,
            ...
            case 13:
                ...
                _e = diff_1.diff(original, update), _ = _e.id, name_1 = _e.name, owner = _e.owner, type = _e.type, bounds = _e.bounds, ownedElements = _e.ownedElements, difference = tslib_1.__rest(_e, ["id", "name", "owner", "type", "bounds", "ownedElements"]);
                if (!Object.keys(difference).length) return [3 /*break*/, 15];
                return [4 /*yield*/, effects_1.put(uml_element_repository_1.UMLElementRepository.update(update.id, tslib_1.__assign({}, difference)))];
            case 14:
                _h.sent();
                _h.label = 15;
            case 15: return [4 /*yield*/, effects_1.call(render, update.owner || diagram.id)];
            case 16:
                _h.sent();
                _h.label = 17;
            case 17:
