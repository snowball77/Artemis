...
export declare type Actions = EditorActions | LayouterActions | UMLContainerActions | UMLElementActions | UMLRelationshipActions | UMLDiagramActions | ConnectableActions | ReconnectableActions | HoverableActions | InteractableActions | MovableActions | MovingActions | ResizableActions | ResizingActions | SelectableActions | UpdatableActions | AssessmentActions | UndoActions;
