...
function UMLDiagramSaga() {
    return tslib_1.__generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, sagas_1.run([selectRelationship, resizeAfterConnectionChange])];
            case 1:
                _a.sent();
                return [2 /*return*/];
        }
...
function selectRelationship() {
    ...
    return tslib_1.__generator(this, function (_b) {
        switch (_b.label) {
            case 0: return [4 /*yield*/, effects_1.take("@@element/selectable/SELECT" /* SELECT */)];
            case 1:
                action = _b.sent();
...
function resizeAfterConnectionChange() {
    return tslib_1.__generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, effects_1.takeLatest(["@@element/connectable/END" /* END */, "@@element/reconnectable/END" /* END */, "@@element/updatable/END" /* END */], resize)];
            case 1:
                _a.sent();
                return [2 /*return*/];
        }
...
function resize() {
    ...
    return tslib_1.__generator(this, function (_c) {
        switch (_c.label) {
            case 0: return [4 /*yield*/, effects_1.getContext('layer')];
            case 1:
                layer = _c.sent();
                return [4 /*yield*/, effects_1.select()];
            case 2:
                _a = _c.sent(), elements = _a.elements, diagram = _a.diagram;
                children = tslib_1.__spread(diagram.ownedElements.map(function (id) { return uml_element_repository_1.UMLElementRepository.get(elements[id]); }), diagram.ownedRelationships.map(function (id) { return uml_relationship_repository_1.UMLRelationshipRepository.get(elements[id]); })).filter(not_empty_1.notEmpty);
