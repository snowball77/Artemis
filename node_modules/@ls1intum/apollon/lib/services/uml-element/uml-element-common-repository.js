...
exports.UMLElementCommonRepository = {
     ...
     */
    create: function (value, owner) { return function (dispatch) { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
        var values, roots;
        return tslib_1.__generator(this, function (_a) {
            values = Array.isArray(value) ? value : [value];
            dispatch({
                type: "@@element/CREATE" /* CREATE */,
    ...
    getById: function (id) { return function (dispatch, getState) {
    ...
    delete: function (id) { return function (dispatch, getState) {
        ...
        dispatch({
            ...
            payload: { ids: tree_1.getChildren(roots, elements) },
            undoable: false,
        });
    }; },
    /** Composes the absolute position of an element */
    getAbsolutePosition: function (id) { return function (dispatch, getState) {
        var elements = getState().elements;
    ...
    getChildren: function (id) { return function (dispatch, getState) {
        var elements = getState().elements;
        ...
        if (uml_container_1.UMLContainer.isUMLContainer(owner)) {
            return owner.ownedElements.reduce(function (acc, element) { return tslib_1.__spread(acc, dispatch(exports.UMLElementCommonRepository.getChildren(element))); }, [owner]);
        }
        return [owner];
    }; },
};
