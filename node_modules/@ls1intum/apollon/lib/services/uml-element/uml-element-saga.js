...
function UMLElementSaga() {
    return tslib_1.__generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, sagas_1.run([makeInteractable, renderAfterUpdate, renderWhileResize])];
            case 1:
                _a.sent();
                return [2 /*return*/];
        }
    ...
    return tslib_1.__generator(this, function (_d) {
        switch (_d.label) {
            ...
            case 3:
                ...
                value = _b.value;
                return [4 /*yield*/, effects_1.call(layouter_1.render, value.id)];
            case 4:
                _d.sent();
                _d.label = 5;
            case 5:
...
function renderWhileResize() {
    ...
    return tslib_1.__generator(this, function (_d) {
        switch (_d.label) {
            case 0: return [4 /*yield*/, effects_1.take("@@element/resizable/RESIZE" /* RESIZE */)];
            case 1:
                action = _d.sent();
                if (sagas_1.isInternal(action)) {
                    return [2 /*return*/];
            ...
            case 3:
                if (!!_b.done) return [3 /*break*/, 6];
                id = _b.value;
                return [4 /*yield*/, effects_1.call(layouter_1.render, id)];
            case 4:
                _d.sent();
                _d.label = 5;
            case 5:
