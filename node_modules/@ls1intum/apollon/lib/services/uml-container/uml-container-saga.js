...
function UMLContainerSaga() {
    return tslib_1.__generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, sagas_1.run([append, remove, appendAfterMove, renderAfterMove])];
            case 1:
                _a.sent();
                return [2 /*return*/];
        }
...
function append() {
    ...
    return tslib_1.__generator(this, function (_c) {
        switch (_c.label) {
            case 0: return [4 /*yield*/, effects_1.take("@@element/container/APPEND" /* APPEND */)];
            case 1:
                action = _c.sent();
            ...
            case 2:
                ...
                return [4 /*yield*/, effects_1.call(layouter_1.render, container.id)];
            case 3:
                _c.sent();
                return [2 /*return*/];
        }
...
function remove() {
    ...
    return tslib_1.__generator(this, function (_d) {
        switch (_d.label) {
            case 0: return [4 /*yield*/, effects_1.take("@@element/container/REMOVE" /* REMOVE */)];
            case 1:
                action = _d.sent();
            ...
            case 3:
                ...
                state = tslib_1.__assign(tslib_1.__assign({}, elements), (_b = {}, _b[diagram.id] = diagram, _b));
                owners = tslib_1.__spread(new Set(action.payload.ids.filter(function (id) { return id in state; }).map(function (id) { return state[id].owner || diagram.id; })));
                _d.label = 4;
            case 4:
            ...
            case 5:
                ...
                return [4 /*yield*/, effects_1.call(layouter_1.render, owner)];
            case 6:
                _d.sent();
                _d.label = 7;
            case 7:
...
function appendAfterMove() {
    ...
    return tslib_1.__generator(this, function (_b) {
        switch (_b.label) {
            case 0: return [4 /*yield*/, effects_1.take("@@element/movable/END" /* END */)];
            case 1:
                action = _b.sent();
                return [4 /*yield*/, effects_1.select()];
            case 2:
                ...
                return [4 /*yield*/, effects_1.put(uml_container_repository_1.UMLContainerRepository.remove(movedElements))];
            case 3:
                _b.sent();
                return [4 /*yield*/, effects_1.put(uml_container_repository_1.UMLContainerRepository.append(movedElements, containerID || undefined))];
            case 4:
                _b.sent();
                return [2 /*return*/];
        }
        ...
        switch (_c.label) {
            ...
            case 2:
                ...
                return [4 /*yield*/, effects_1.race({
                        append: effects_1.take("@@element/container/APPEND" /* APPEND */),
                        resize: effects_1.call(function () {
                            var owners, owners_2, owners_2_1, owner, e_2_1;
                            var e_2, _a;
                            return tslib_1.__generator(this, function (_b) {
                                switch (_b.label) {
                                    case 0: return [4 /*yield*/, effects_1.delay(0)];
                                    case 1:
                                        _b.sent();
                                        owners = tslib_1.__spread(new Set(action.payload.ids.map(function (id) { return state[id].owner || diagram.id; })));
                                        _b.label = 2;
                                    case 2:
